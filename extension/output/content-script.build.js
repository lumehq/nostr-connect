(() => {
	...
	var EXTENSION = "nostrconnect";
	var script = document.createElement("script");
	script.setAttribute("async", "false");
	script.setAttribute("type", "text/javascript");
	script.setAttribute(
		"src",
		import_webextension_polyfill.default.runtime.getURL("nostr-provider.js"),
	);
	...
	self.addEventListener("message", async (message) => {
		...
		var response;
		try {
			response = await import_webextension_polyfill.default.runtime.sendMessage(
				{
