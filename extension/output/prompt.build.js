				...
				(module2) => {
					if (
						...
						const wrapAPIs = (extensionAPIs) => {
							...
							const hasOwnProperty = Function.call.bind(
		...
		"node_modules/.pnpm/object-assign@4.1.1/node_modules/object-assign/index.js"(
			...
			function shouldUseNative() {
				try {
					...
					var order2 = Object.getOwnPropertyNames(test2).map((n) => test2[n]);
			...
			if (true) {
				(() => {
					...
					function printWarning(level, format, args) {
						...
						var argsWithFormat = args.map((item) => "" + item);
					...
					var ReactElement = (type, key, ref, self2, source, owner, props) => {
						var element = {
			...
			if (true) {
				(() => {
					...
					if (
						...
						requestHostTimeout = (cb, ms) => {
							_timeoutID = setTimeout(cb, ms);
						};
						cancelHostTimeout = () => {
							clearTimeout(_timeoutID);
						};
						exports.unstable_shouldYield = () => false;
				...
				(() => {
					...
					function validateProps(element, props) {
						if (typeof props.children === "object" && props.children !== null) {
							React3.Children.forEach(props.children, (child) => {
								if (child == null) {
									return;
								}
					...
					var createMicrosoftUnsafeLocalFunction = (func) => {
					...
					var camelize = (string) =>
						string.replace(hyphenPattern, (_, character) =>
							character.toUpperCase(),
						);
					var warnHyphenatedStyleName = (name) => {
						if (
					...
					var warnBadVendoredStyleName = (name) => {
						if (
							warnedStyleNames.hasOwnProperty(name) &&
							warnedStyleNames[name]
						) {
					...
					var warnStyleValueWithSemicolon = (name, value) => {
						if (
					...
					var warnStyleValueIsNaN = (name, value) => {
					...
					var warnStyleValueIsInfinity = (name, value) => {
					...
					validateProperty$1 = (tagName, name, value, eventRegistry) => {
						if (
					...
					var warnUnknownProperties = (type, props, eventRegistry) => {
						var unknownProps = [];
						for (var key in props) {
					...
					var batchedUpdatesImpl = (fn, bookkeeping) => fn(bookkeeping);
					var discreteUpdatesImpl = (fn, a, b, c, d) => fn(a, b, c, d);
					...
					if (
						...
						invokeGuardedCallbackImpl = function invokeGuardedCallbackDev(
							...
							function restoreAfterDispatch() {
								...
								if (
									typeof self.event !== "undefined" &&
									self.hasOwnProperty("event")
								) {
					...
					function retryIfBlockedOn(unblocked) {
						...
						var unblock = (queuedEvent2) =>
							scheduleCallbackIfUnblocked(queuedEvent2, unblocked);
					...
					var canUseTextInputEvent =
						canUseDOM && "TextEvent" in self && !documentMode;
					...
					function getSelection$1(node) {
						if ("selectionStart" in node && hasSelectionCapabilities(node)) {
							...
							var win =
								(node.ownerDocument && node.ownerDocument.defaultView) || self;
							var selection = win.getSelection();
							return {
					...
					normalizeMarkupForTextOrAttribute = (markup) => {
						var markupString =
					...
					warnForTextDifference = (serverText, clientText) => {
					...
					warnForPropDifference = (propName, serverValue, clientValue) => {
						if (didWarnInvalidHydration) {
							return;
						}
					...
					warnForInvalidEventListener = (registrationName, listener) => {
						if (listener === false) {
							error(
					...
					updatedAncestorInfo = (oldInfo, tag) => {
					...
					var isTagValidWithParent = (tag, parentTag) => {
						switch (parentTag) {
							case "select":
								return (
					...
					var findInvalidAncestorForTag = (tag, ancestorInfo) => {
						switch (tag) {
							case "address":
							case "article":
							case "aside":
					...
					var didWarn$1 = {};
					validateDOMNesting = (childTag, childText, ancestorInfo) => {
					...
					var now =
						initialTimeMs$1 < 1e4
							? Scheduler_now$1
							: () => Scheduler_now$1() - initialTimeMs$1;
					...
					warnOnUndefinedDerivedState = (type, partialState) => {
					...
					var warnForMissingKey = (child, returnFiber) => {};
					...
					function cloneChildFibers(current2, workInProgress2) {
						if (
							!(current2 === null || workInProgress2.child === current2.child)
						) {
					...
					function useMutableSource(hook, source, getSnapshot, subscribe) {
						...
						var _dispatcher$useState = dispatcher.useState(() =>
								readFromUnsubcribedMutableSource(root2, source, getSnapshot),
							),
					...
					var callComponentWillUnmountWithTimer = (current2, instance) => {
					...
					var workInProgressRootRenderTargetTime = Number.POSITIVE_INFINITY;
					...
					var beginWork$1;
					var dummyFiber = null;
					beginWork$1 = (current2, unitOfWork, lanes) => {
...
For more info, visit https://reactjs.org/link/mock-scheduler`);
					...
					var scheduleRefresh = (root2, update) => {
						if (resolveFamily === null) {
							return;
						}
					...
					var scheduleRoot = (root2, element) => {
					...
					var findHostInstancesForRefresh = (root2, families) => {
						var hostInstances = /* @__PURE__ */ new Set();
						var types = new Set(families.map((family) => family.current));
					...
					var createFiber = (tag, pendingProps, key, mode) =>
					...
					var shouldSuspendImpl = (fiber) => false;
					...
					var copyWithDeleteImpl = (obj, path, index2) => {
						var key = path[index2];
					...
					var copyWithDelete = (obj, path) => copyWithDeleteImpl(obj, path, 0);
					var copyWithRenameImpl = (obj, oldPath, newPath, index2) => {
					...
					var copyWithRename = (obj, oldPath, newPath) => {
					...
					var copyWithSetImpl = (obj, path, index2, value) => {
					...
					var copyWithSet = (obj, path, value) =>
						copyWithSetImpl(obj, path, 0, value);
					var findHook = (fiber, id) => {
	...
	// node_modules/.pnpm/@radix-ui+react-checkbox@1.0.4_react-dom@17.0.2_react@17.0.2/node_modules/@radix-ui/react-checkbox/dist/index.mjs
	var import_react12 = __toESM(require_react(), 1);

	// node_modules/.pnpm/@radix-ui+react-compose-refs@1.0.1_react@17.0.2/node_modules/@radix-ui/react-compose-refs/dist/index.mjs
	...
	// node_modules/.pnpm/@radix-ui+react-context@1.0.1_react@17.0.2/node_modules/@radix-ui/react-context/dist/index.mjs
	...
	function $c512c27ab02ef895$export$50c7b4e9d9f19c1(
		...
		function $c512c27ab02ef895$export$fd42f52fd3ae1109(
			...
			const BaseContext = /* @__PURE__ */ (0, import_react3.createContext)(
				defaultContext,
			);
	...
	// node_modules/.pnpm/@radix-ui+react-use-controllable-state@1.0.1_react@17.0.2/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
	var import_react5 = __toESM(require_react(), 1);

	// node_modules/.pnpm/@radix-ui+react-use-callback-ref@1.0.1_react@17.0.2/node_modules/@radix-ui/react-use-callback-ref/dist/index.mjs
	...
	// node_modules/.pnpm/@radix-ui+react-use-previous@1.0.1_react@17.0.2/node_modules/@radix-ui/react-use-previous/dist/index.mjs
	...
	// node_modules/.pnpm/@radix-ui+react-use-size@1.0.1_react@17.0.2/node_modules/@radix-ui/react-use-size/dist/index.mjs
	var import_react8 = __toESM(require_react(), 1);

	// node_modules/.pnpm/@radix-ui+react-use-layout-effect@1.0.1_react@17.0.2/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
	var import_react7 = __toESM(require_react(), 1);
	var $9f79659886946c16$export$e5c5a5f917a5871c = Boolean(
		globalThis === null || globalThis === void 0 ? void 0 : globalThis.document,
	)
		? import_react7.useLayoutEffect
		: () => {};
	...
	// node_modules/.pnpm/@radix-ui+react-presence@1.0.1_react-dom@17.0.2_react@17.0.2/node_modules/@radix-ui/react-presence/dist/index.mjs
	...
	var $921a889cee6df7e8$export$99c2b779aa4e8b8b = (props) => {
		...
		return forceMount || presence.isPresent
			? /* @__PURE__ */ (0, import_react9.cloneElement)(child, {
					ref,
				})
			: null;
	};
	...
	// node_modules/.pnpm/@radix-ui+react-primitive@1.0.3_react-dom@17.0.2_react@17.0.2/node_modules/@radix-ui/react-primitive/dist/index.mjs
	var import_react11 = __toESM(require_react(), 1);
	var import_react_dom2 = __toESM(require_react_dom(), 1);

	// node_modules/.pnpm/@radix-ui+react-slot@1.0.2_react@17.0.2/node_modules/@radix-ui/react-slot/dist/index.mjs
	var import_react10 = __toESM(require_react(), 1);
	var $5e63c961fc1ce211$export$8c6ed5c666ac1360 = /* @__PURE__ */ (0,
	import_react10.forwardRef)((props, forwardedRef) => {
		...
		if (slottable) {
			...
			const newChildren = childrenArray.map((child) => {
				if (child === slottable) {
					...
					return /* @__PURE__ */ (0, import_react10.isValidElement)(newElement)
			...
			return /* @__PURE__ */ (0, import_react10.createElement)(
				...
				/* @__PURE__ */ (0, import_react10.isValidElement)(newElement)
					? /* @__PURE__ */ (0, import_react10.cloneElement)(
							newElement,
							void 0,
							newChildren,
						)
	...
	var $5e63c961fc1ce211$var$SlotClone = /* @__PURE__ */ (0,
	import_react10.forwardRef)((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		...
		return import_react10.Children.count(children) > 1
			? import_react10.Children.only(null)
			: null;
	});
	...
	function $5e63c961fc1ce211$var$isSlottable(child) {
		return (
			/* @__PURE__ */ (0, import_react10.isValidElement)(child) &&
	...
	var $8927f6f2acc4f386$export$250ffa63cdc0d034 =
		$8927f6f2acc4f386$var$NODES.reduce((primitive, node) => {
			const Node = /* @__PURE__ */ (0, import_react11.forwardRef)(
				(props, forwardedRef) => {
	...
	var [
		...
		$e698a72e93240346$var$CHECKBOX_NAME,
	);
	var [
	...
	var $e698a72e93240346$export$48513f6b9f8ce62d = /* @__PURE__ */ (0,
	import_react12.forwardRef)((props, forwardedRef) => {
		const {
			__scopeCheckbox,
			name,
			checked: checkedProp,
		...
		return /* @__PURE__ */ (0, import_react12.createElement)(
			...
			/* @__PURE__ */ (0, import_react12.createElement)(
				$8927f6f2acc4f386$export$250ffa63cdc0d034.button,
				_extends(
					{
						type: "button",
						role: "checkbox",
						"aria-checked": $e698a72e93240346$var$isIndeterminate(checked)
							? "mixed"
							: checked,
	...
	var $e698a72e93240346$export$59aad738f51d1c05 = /* @__PURE__ */ (0,
	import_react12.forwardRef)((props, forwardedRef) => {
		const { __scopeCheckbox, forceMount, ...indicatorProps } = props;
		const context = $e698a72e93240346$var$useCheckboxContext(
			$e698a72e93240346$var$INDICATOR_NAME,
			__scopeCheckbox,
		);
		return /* @__PURE__ */ (0, import_react12.createElement)(
	...
	var $e698a72e93240346$var$BubbleInput = (props) => {
		...
		(0, import_react12.useEffect)(() => {
			...
			const inputProto = self.HTMLInputElement.prototype;
			...
			if (prevChecked !== checked && setChecked) {
				...
				setChecked.call(
					input,
					$e698a72e93240346$var$isIndeterminate(checked) ? false : checked,
				);
			...
			_extends(
				{
					type: "checkbox",
					"aria-hidden": true,
					defaultChecked: $e698a72e93240346$var$isIndeterminate(checked)
						? false
						: checked,
				},
				inputProps,
	...
	var $e698a72e93240346$export$be92b6f5f03c0fe9 =
		$e698a72e93240346$export$48513f6b9f8ce62d;
	var $e698a72e93240346$export$adb584737d712b70 =
		$e698a72e93240346$export$59aad738f51d1c05;

	// extension/prompt.jsx
	function Prompt() {
		const [isRemember, setIsRemember] = (0, import_react13.useState)(false);
		...
		function authorizeHandler(accept) {
			...
			return (ev) => {
				ev.preventDefault();
				import_webextension_polyfill2.default.runtime.sendMessage({
					prompt: true,
					id,
					host,
					type,
		...
		return /* @__PURE__ */ import_react13.default.createElement(
			...
			/* @__PURE__ */ import_react13.default.createElement(
				...
				{
					className:
						"p-8 shadow-primary border border-primary rounded-2xl max-w-xl mx-auto flex flex-col gap-5",
				},
				/* @__PURE__ */ import_react13.default.createElement(
					"div",
					{
					...
					/* @__PURE__ */ import_react13.default.createElement(LogoIcon, null),
					/* @__PURE__ */ import_react13.default.createElement(
						"div",
						{
					...
					/* @__PURE__ */ import_react13.default.createElement(
						...
						/* @__PURE__ */ import_react13.default.createElement(
							$e698a72e93240346$export$be92b6f5f03c0fe9,
							{
								id: "remember",
								className:
									"flex h-6 w-6 appearance-none items-center justify-center rounded-lg bg-white outline-none border border-primary data-[state=checked]:bg-primary data-[state=checked]:border-secondary",
					...
					/* @__PURE__ */ import_react13.default.createElement(
						...
						/* @__PURE__ */ import_react13.default.createElement(
							"button",
							{
								...
								className:
									"flex-1 h-10 rounded-lg shadow-sm border border-primary inline-flex items-center justify-center font-semibold",
							},
							"Reject",
						),
						/* @__PURE__ */ import_react13.default.createElement(
							"button",
							{
								...
								className:
									"flex-1 h-10 rounded-lg shadow-sm border border-secondary bg-primary text-white inline-flex items-center justify-center font-semibold",
							},
							"Authorize",
						),
					),
	...
	(0, import_react_dom3.render)(
		/* @__PURE__ */ import_react13.default.createElement(Prompt, null),
